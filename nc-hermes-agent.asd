...
(defsystem "nc-hermes-agent"
  ...
  :components ((:module "src"
                ...
                ((:file "config")
                 ...
                 (:file "file-tools" :depends-on ("skills" "tools"))
                 (:file "web-tools" :depends-on ("skills" "tools"))
                 (:file "search-tools" :depends-on ("skills" "tools" "config"))
                 (:file "github-tools" :depends-on ("skills" "tools" "config"))
                 (:file "mcp-client" :depends-on ("config" "tools" "skills"))
                 (:file "trajectory" :depends-on ("config"))
                 (:file "llm" :depends-on ("config" "state"))
                 (:file "mcp" :depends-on ("config" "tools"))
                 (:file "agent" :depends-on ("config" "state" "llm" "tools" "skills" "core-tools" "file-tools" "web-tools" "search-tools" "github-tools" "mcp-client" "trajectory"))
